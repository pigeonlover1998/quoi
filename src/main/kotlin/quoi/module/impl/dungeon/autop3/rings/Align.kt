...
@TypeName("align")
open class AlignAction : P3Action {
    ...
    override fun tick(player: LocalPlayer, clientInput: Input, input: MutableInput): Boolean {
        ...
        if (yawQueue.isEmpty()) {
            ...
            return player.position().distanceToSqr(target) <= getPrecision()
        }
    ...
    protected open fun getPrecision(): Double {
        return 0.01 * 0.01
    }
    
    override fun feedbackMessage() = "Aligning!"
}
