...
object Tweaks : Module(
    ...
    @JvmStatic val disableCrawling by BooleanSetting("Disable crawling", desc = "Disables crawling animation (does not disable swimming).").withDependency(skyblockOnly)
