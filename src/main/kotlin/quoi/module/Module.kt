...
abstract class Module(
    ...
    inline val mc get() = QuoiMod.mc
    inline val level get() = requireNotNull(mc.level) { "tried to access level before world was loaded" } // should never be null in tick events
    inline val player get() = requireNotNull(mc.player) { "tried to access player before it was loaded" } // should never be null in tick events
